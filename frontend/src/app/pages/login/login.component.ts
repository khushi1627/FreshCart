        ...
        <div class="w-full max-w-md">
          ...
          <div class="backdrop-blur-xl bg-white/90 rounded-3xl shadow-2xl border border-white/20 p-8 animate-fade-in">
            <div class="text-center mb-8">
              ...
              <p class="text-gray-600 text-lg">Sign in to your FreshCart account</p>
            </div>
              ...
              <div class="space-y-2">
                ...
                <div class="relative group">
                  ...
                  <div class="absolute inset-y-0 right-0 pr-4 flex items-center opacity-0 peer-focus-within:opacity-100 transition-opacity">
                    <i class="fas fa-check-circle text-emerald-500" *ngIf="loginForm.get('email')?.valid && loginForm.get('email')?.touched"></i>
                  </div>
                </div>
              ...
              <div class="space-y-2">
                ...
                <div class="relative group">
                  ...
                  <input [type]="showPassword ? 'text' : 'password'" formControlName="password"
                         class="input-modern pl-11 pr-11 peer" placeholder="Enter your password">
            ...
            <div class="mt-8 text-center space-y-4">
              <div class="relative">
                ...
                <div class="relative flex justify-center text-sm">
                  <span class="px-4 bg-white/90 backdrop-blur text-gray-500">New to FreshCart?</span>
                </div>
              </div>
              <a routerLink="/register" class="inline-flex items-center gap-2 text-emerald-600 font-semibold hover:text-emerald-700 transition-colors group">
